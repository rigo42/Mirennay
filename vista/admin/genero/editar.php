            ...
            <div class="col-md-6">
                <div class="card">
                    <form class="form-horizontal" id="editar">
                        ...
                        <div class="card-body">
                            <h6 class="card-title">Datos del genero <?php echo $value['genero'] ?></h6>
                            <div class="form-group row">
                                <label class="col-sm-3 text-right control-label col-form-label">Genero</label>
                                <div class="col-sm-9">
                                    <input type="text" required name="genero" value="<?php echo $value['genero'] ?>" class="form-control" placeholder="Nombre del genero">
                                </div>
                            </div>
                             <div class="form-group row">
                            ...
                            <!-- inputs ocultos -->
                            <input type="hidden" name="idGenero" value="<?php echo openssl_encrypt($idGenero, COD, KEY) ?>">       
...
<script type="text/javascript">
   $(document).ready(function(){
        ...
        tittlePage("#menuGenero","Genero | Editar");
