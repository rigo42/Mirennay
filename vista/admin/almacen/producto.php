            ...
            <div class="el-card-avatar el-overlay-1"> <img src="<?php echo URL ?>libreria/imgProducto/<?php echo $key['imagen_principal'] ?>" alt="user" />
                <div class="el-overlay">
                    <ul class="list-style-none el-info">
                        ...
                        <li class="el-item"><a class="btn default btn-outline el-link" href="<?php echo URL ?>adminAlmacen/editar?idProducto=<?php echo urlencode(openssl_encrypt($key['id_producto'], COD, KEY))?>"><i class="fas fa-edit"></i></a></li>
                    </ul>
                </div>
            </div>
