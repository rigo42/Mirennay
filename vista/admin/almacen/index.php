<div class="page-wrapper">
                    ...
                    <div class="col-md-5">
                        <div class="input-group">
                            ...
                            <div class="input-group-append">
                                <a href="<?php echo URL ?>adminAlmacen/nuevo" class="input-group-text" title="Nuevo" style="cursor: pointer;"><i class="fas fa-plus"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="container-fluid">
        <div class="row el-element-overlay" id="tablaDinamica" data-url="adminAlmacen/producto">
        </div>
    </div>
...
<script type="text/javascript">
    tittlePage("#menuProducto","Almacen");
    tablaDinamica("","adminAlmacen/producto",1);
</script>