 <div class="page-wrapper">
                    ...
                    <div class="col-md-5">
                        <div class="input-group">
                            ...
                            <div class="input-group-append">
                                <a href="<?php echo URL ?>adminTalla/nuevo" class="input-group-text" title="Nuevo" style="cursor: pointer;"><i class="fas fa-plus"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="container-fluid">
        <div id="tablaDinamica" data-url="adminTalla/mostrar">
        </div>
    </div>
...
<script type="text/javascript">
    tittlePage("#menuTalla","Tallas");
    tablaDinamica("","adminTalla/mostrar",1);
</script>