<div class="page-wrapper">
                    ...
                    <div class="col-md-5">
                        <div class="input-group">
                            ...
                            <div class="input-group-append">
                                <a href="<?php echo URL ?>adminCategoria/nuevo" class="input-group-text" title="Nuevo" style="cursor: pointer;"><i class="fas fa-plus"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="container-fluid">
        <div id="tablaDinamica" data-url="adminCategoria/mostrar">
        </div>
    </div>
...
<script type="text/javascript">
    tittlePage("#menuCategoria","Categorias");
    tablaDinamica("","adminCategoria/mostrar",1);
</script>